...
// Kotlin's ignoreCase folding is Unicode-wide and folds U+017F onto 'S', so `algorithm=%C5%BFHA256`
// would name SHA-256 while the otpauth ABNF admits only VCHAR.
